...
const Navbar = () => {
  return (
    <div className='bg-[#EFE2D9] flex gap-10 justify-between items-center'>
        <img className='h-20 ml-20' src="https://sproviero-type.com/_astro/fleur.B9lZftXp_19naF5.svg" alt="" />
